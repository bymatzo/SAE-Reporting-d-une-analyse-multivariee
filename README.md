...
1. Diagnostic visuel (heatmap + pattern de co-absence par ACM)
2. Suppression des colonnes avec > `seuil_col` % de NaN (défaut : 70 %)
3. Suppression des lignes avec > `seuil_ligne` % de NaN (défaut : 50 %)
4. **Imputation par ACP itérative régularisée** pour les variables quantitatives (algorithme missMDA — Josse & Husson, 2009)
